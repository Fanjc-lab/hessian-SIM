...
if isequal(filename,0)
   ...
   disp(['User selected£º', fullfile(pathname, filename)])
...
if     get(handles.radiobutton1,'Value')==1 && get(handles.radiobutton2,'Value')==0 && get(handles.radiobutton3,'Value')==0
    weila_21_low_signal
elseif get(handles.radiobutton1,'Value')==0 && get(handles.radiobutton2,'Value')==1 && get(handles.radiobutton3,'Value')==0
    Bregman_Hessian_Denoise
...
if isequal(otf_filename,0)
    ...
    disp(['User selected£º', fullfile(otf_pathname, otf_filename)])
...
if isequal(bg_filename,0)
    ...
    disp(['User selected£º', fullfile(bg_pathname, bg_filename)])
